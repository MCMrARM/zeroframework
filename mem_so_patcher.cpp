...
#define HOOK_SYSCALL(name, hook) \
    ...
    linker_hook_successful = hooked_mmap2 && (hooked_open || hooked_openat);
    if (linker_hook_successful)
        return true;
#ifndef __i386__
    // try to find the alternative pattern
